...
if "run_phase" not in st.session_state:
...
# ---------------------- Run checks button ----------------------
if st.button("Run checks", type="primary", key="run_checks_btn"):
...
if st.session_state.run_phase == "run_checks":
    try:
        ...
        # IMPORTANT: use dfs here, not [columns, requirement, status]
        ...
        # Reset phase so the "Running checks..." message disappears
        st.session_state.run_phase = "idle"
