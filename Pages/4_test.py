...
#    # when running in stlite
    ref_org_URL = (
    "https://raw.githubusercontent.com/pete4nhs/test_DQ_checks_delete_after_use/main/reference_tables/ICB_and_SubICB_Apr2026.csv")
...
#    del_df = pd.read_csv(r"C:\Users\peter.saiu\OneDrive - NHS\Scripts\Python\Automating Local Prices checks\reference_tables\Delegationservices_v38.csv")
    ...
    # when running in stlite
    del_serv_URL = ("https://raw.githubusercontent.com/pete4nhs/test_DQ_checks_delete_after_use/main/reference_tables/Delegationservices_v38.csv")
...
#    npod = pd.read_csv(r"C:\Users\peter.saiu\OneDrive - NHS\Scripts\Python\Automating Local Prices checks\reference_tables/NPOD.csv")
    ...
    # when running in stlite
    NPOD_URL = ("https://raw.githubusercontent.com/pete4nhs/test_DQ_checks_delete_after_use/main/reference_tables/NPOD.csv")
